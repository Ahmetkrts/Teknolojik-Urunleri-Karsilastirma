...
CREATE TABLE IF NOT EXISTS `telefon` (
  ...
  `telefon_ram_frekansi` double NOT NULL DEFAULT 0,
  `telefon_dahili_depolama` int(11) NOT NULL DEFAULT 0,
  `telefon_boy` int(11) NOT NULL DEFAULT 0,
...
-- Dumping data for table compare-tech.telefon_on_kamera: ~3 rows (approximately)
